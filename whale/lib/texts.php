...
function whale_texts()
{
    return [
        'fa' => [
            ...
            'card_gb' => 'گیگ',
            'card_days' => 'روز',
            'btn_volume' => '➕ حجم اضافه',
            'volume_pick' => "➕ <b>حجم اضافه</b>\n\nسرویس: <code>{username}</code>\n📊 باقی‌مانده‌ی فعلی: <b>{left}</b>\n\nبسته را انتخاب کنید؛ حجم بلافاصله به سرویس اضافه می‌شود و مدت آن تغییری نمی‌کند.",
            'btn_volume_pack' => '📊 {gb} گیگ — {price} تومان',
            'volume_confirm' => "➕ <b>تأیید خرید حجم</b>\n\nسرویس: <code>{username}</code>\n📊 حجم اضافه: <b>{gb}</b> گیگ\n💰 مبلغ: <b>{price}</b> تومان\n💳 موجودی شما: {balance} تومان",
            'volume_done' => "✅ <b>{gb} گیگ</b> به سرویس <code>{username}</code> اضافه شد.\n📊 حجم کل سرویس حالا <b>{total}</b> گیگ است.",
            'volume_failed' => '⚠️ افزودن حجم روی سرور انجام نشد. مبلغی کسر نشد؛ لطفاً کمی بعد دوباره تلاش کنید.',
            'volume_not_sold' => '➕ حجم اضافه فعلاً برای این سرویس در دسترس نیست.',
            'reason_volume' => 'حجم اضافه {gb} گیگ برای {username}',
            'test_nudge_done' => '',
        ],
        'en' => [
            'test_creating' => '⏳',
            ...
            'card_gb' => 'GB',
            'card_days' => 'days',
            'btn_volume' => '➕ Extra data',
            'volume_pick' => "➕ <b>Extra data</b>\n\nService: <code>{username}</code>\n📊 Left now: <b>{left}</b>\n\nPick a pack; it is added right away and the expiry does not change.",
            'btn_volume_pack' => '📊 {gb} GB — {price} Toman',
            'volume_confirm' => "➕ <b>Confirm extra data</b>\n\nService: <code>{username}</code>\n📊 Extra: <b>{gb}</b> GB\n💰 Price: <b>{price}</b> Toman\n💳 Your balance: {balance} Toman",
            'volume_done' => "✅ <b>{gb} GB</b> added to <code>{username}</code>.\n📊 The service now has <b>{total}</b> GB in total.",
            'volume_failed' => '⚠️ Adding data failed on the server. Nothing was charged; please try again later.',
            'volume_not_sold' => '➕ Extra data is not available for this service right now.',
            'reason_volume' => 'Extra {gb} GB for {username}',
            'test_nudge_done' => '',
        ],
    ];
}
